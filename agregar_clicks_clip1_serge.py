"""
Script para agregar clicks de audio a "entrv señores - clip1_serge".
...
Uso:
    python agregar_clicks_clip1_serge.py [draft_folder] [ruta_sonido]
"""
...
DRAFT_NAME = "entrv señores - clip1_serge"
